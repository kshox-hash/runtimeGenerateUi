...
function generateQuotePdf(record: RuntimeLinkRecord, submitBody: SubmitBody) {
  return new Promise<{ fileName: string; filePath: string }>((resolve, reject) => {
    try {
      ...
      doc
        .roundedRect(margin, y, contentWidth, 96, 10)
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fontSize(12)
        .text("De", margin + 18, y + 16);

      doc
        .font("Helvetica-Bold")
        .fontSize(15)
        .text("Automatiza Fácil", margin + 18, y + 34);
      ...
      doc
        ...
        .fontSize(10)
        .fillColor(colors.muted)
        .text(`N° cotización: ${quoteNumber}`, rightX, y + 36, {
          width: 160,
          align: "right",
        })
        .text(`Fecha: ${issueDate}`, rightX, y + 52, {
          width: 160,
          align: "right",
        })
        .text(`Referencia: ${record.token}`, rightX, y + 68, {
          width: 160,
          align: "right",
        });
        ...
        quote.lines.forEach((line, index) => {
          ...
          if (line.description) {
            doc
              ...
              .font("Helvetica")
              .fontSize(8.5)
              .text(line.description, col1, y + 24, {
                width: 270,
              });
          }
          ...
          doc
            ...
            .font("Helvetica")
            .fontSize(10)
            .text(String(line.quantity), col2, y + 14, {
              width: 60,
              align: "center",
            })
            .text(formatCurrencyCLP(line.unitPrice), col3, y + 14, {
              width: 70,
              align: "right",
            })
            .text(formatCurrencyCLP(line.subtotal), col4, y + 14, {
              width: 80,
              align: "right",
            });
      ...
      doc
        .roundedRect(leftBoxX, y, notesBoxWidth, boxHeight, 10)
        .fillAndStroke(colors.white, colors.border);
      ...
      doc
        .roundedRect(rightBoxX, y, totalsBoxWidth, boxHeight, 10)
        .fillAndStroke(colors.lighter, colors.border);
      ...
      doc
        ...
        .text(formatCurrencyCLP(quote.total), valueX, y + 20, {
          width: 96,
          align: "right",
        });

      doc
        .text("Descuento", labelX, y + 44)
        .text(formatCurrencyCLP(0), valueX, y + 44, {
          width: 96,
          align: "right",
        });
